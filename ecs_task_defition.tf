resource "aws_ecs_task_definition" "devnology_api_task" {
  ...
  container_definitions = jsonencode([
    {
      name      = "devnology-api"
      image     = "416997488095.dkr.ecr.sa-east-1.amazonaws.com/devnology-api:0f27b15d8a377e80f84034102a8c36f98e5dbae4"
      essential = true
      portMappings = [
        {
          containerPort = 3001
  ...
  container_definitions = jsonencode([
    {
      ...
      image     = "416997488095.dkr.ecr.sa-east-1.amazonaws.com/devnologyweb-ui:fc94120fc96fbe21343f3f420a5d0b33b949e6bd"
      essential = true
      portMappings = [
        {
          containerPort = 80
